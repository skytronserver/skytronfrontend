          ...
          <Stack spacing={2}>
            ...
            <FormControl fullWidth size="small">
              ...
              >
                ...
                <MenuItem value="LocalAdminOffice">Local Administrative Offices</MenuItem>
                <MenuItem value="Library">Library</MenuItem>
                <MenuItem value="MilkBooth">Milk Booth</MenuItem>
                <MenuItem value="OtherCommunityServices">Other Community Services</MenuItem>
                <MenuItem value="OverheadTank">Overhead Tank</MenuItem>
                <MenuItem value="ParksAndGardens">General Parks and Gardens</MenuItem>
                <MenuItem value="PostTelegraphOffice">Post and Telegraph Office</MenuItem>
                <MenuItem value="BankMoneyExchanger">Banks &amp; Money Exchanger</MenuItem>
                ...
                <MenuItem value="PetrolPump">Petrol Pump</MenuItem>
                <MenuItem value="TouristInfoCentre">Tourist Information Centre</MenuItem>
                <MenuItem value="MetroStation">Metro Station</MenuItem>
                ...
                <MenuItem value="AirlineAccess">Airline Access</MenuItem>
                <MenuItem value="BusTruckParking">Bus and Truck Parking</MenuItem>
                <MenuItem value="ParkingGarage">Parking Garage</MenuItem>
                <MenuItem value="Marina">Marina</MenuItem>
                <MenuItem value="FerryTerminal">Ferry Terminal</MenuItem>
                <MenuItem value="Helipad">Helipad</MenuItem>
                <MenuItem value="RailwayBridge">Railway Bridge</MenuItem>
                <MenuItem value="RailwayTunnel">Railway Tunnel</MenuItem>
                <MenuItem value="RoadBridge">Road Bridge</MenuItem>
                <MenuItem value="RoadTunnel">Road Tunnel</MenuItem>
                <MenuItem value="PoliceOther">Police Other</MenuItem>
                <MenuItem value="PoliceChowki">Police Chowki</MenuItem>
                <MenuItem value="BusTerminal">Bus Terminal</MenuItem>
                <MenuItem value="SportsComplex">Sports Complex</MenuItem>
                <MenuItem value="Airport_Commercial">Airport - Commercial</MenuItem>
                <MenuItem value="Airport_NonCommercial">Airport - Non Commercial</MenuItem>
                <MenuItem value="LocalRailwayStation">Local Railway Station</MenuItem>
                <MenuItem value="DentalHospital">Dental Hospital</MenuItem>
                <MenuItem value="EyeHospital">Eye Hospital</MenuItem>
                <MenuItem value="HomeopathicHospital">Homeopathic Hospital</MenuItem>
                <MenuItem value="HeartHospital">Heart Hospital</MenuItem>
                <MenuItem value="MentalHospital">Mental Hospital</MenuItem>
                <MenuItem value="Optometrist">Optometrist</MenuItem>
                <MenuItem value="OrthopedicHospital">Orthopedic Hospital</MenuItem>
                <MenuItem value="VeterinaryHospital">Veterinary Hospital</MenuItem>
                <MenuItem value="TrafficSignal">Traffic Signal</MenuItem>
                <MenuItem value="TrafficCheckPost">Traffic Check Post</MenuItem>
              </Select>
            </FormControl>
