...
const MapComponent = ({
    ...
    */
    ...
    vehicleType &&
    !["pickup", "drop", "stop", "route"].includes(vehicleType)
        ? vehicleType.toLowerCase().replace(/\s+/g, "_")
        : "bus";
        const availableTypes = [
            "ambulance",
...
//         const itemType = data?.type || "bus";

//         return createIconStyle(
//             itemType === "bus" ? "blue" : "default",
//             itemType,
//             data?.label || data?.vehicle_registration_number || ""
//         );
//     }
...
<circle cx="6" cy="6" r="4" fill="#333" stroke="#fff" stroke-width="2"/>
  ...
  useEffect(() => {
    ...
    // ROUTE LINE
    // =========================
    const routeCoordinates = gpsData
    ...
    gpsData.forEach((item) => {
        ...
        // =========================
            ...
            style = createIconStyle(
                "blue",
                "bus",
                item.label || item.vehicle_reg_no || "Bus"
            );
        }
