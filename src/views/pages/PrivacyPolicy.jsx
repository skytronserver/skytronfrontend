        ...
        <Container maxWidth="md">
          ...
          <Accordion defaultExpanded>
            ...
            <AccordionDetails>
              ...
              Welcome to SkyTron<sup>®</sup>, a vehicle tracking application developed by Skytrack Technologies Pvt Ltd and implemented in collaboration with AMTRON. Your privacy is important to us, and this Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our application SkyTron<sup>®</sup>. By using the application, you agree to the terms outlined in this policy.
              </Typography>
            </AccordionDetails>
          </Accordion>
