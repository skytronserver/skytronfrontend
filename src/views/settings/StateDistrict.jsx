...
import { fetchStateList } from '../../actions/settingAction';
import DynamicDatatables from '../../datatables/DynamicDatatables';
import {stateColumns} from '../../datatables/settingColumns';
function StateDistrict({ fieldConfig, initialData,districtConfig,districtInitials }) {
  ...
  return (
    <>
      ...
      <Grid container spacing={gridSpacing}>
        ...
        >
          <MainCard title="Add District Name">
            ...
            >
              {(formik) => (
                <form onSubmit={formik.handleDistrictSubmit}>
                  <Grid container spacing={2} className="form-controller">
      ...
      <Grid container spacing={gridSpacing}>
        ...
        {load && <DynamicDatatables tableTitle="" rows={stateList} columns={stateColumns}/>}
        </MainCard>
        </Grid>
    </Grid>
    </>
