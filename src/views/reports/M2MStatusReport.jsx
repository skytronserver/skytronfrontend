...
import { m2mStatusColumns } from '../../datatables/deviceColumns';

const M2MStatusReport = () => {
  ...
  const fetchM2MStatus = async () => {
    try {
      const response = await DealerServices.checkM2MStatus({});
          ...
          <Grid item xs={12}>
            ...
            <Datatable
              ...
              options={{
                ...
                downloadOptions: {
                  filename: "m2m_status_report.csv",
                  separator: ","
                }
              }}
            />
...
export default M2MStatusReport; 