...
const user = {
  ...
  children: [
    ...
    {
      id: "stateadmin-technical-onboarding-requests",
      title: "Technical Onboarding Approval",
      type: "item",
      url: "/stateadmin-dashboard/technical-onboarding-requests",
      icon: icons.IconCircleCheck,
      breadcrumbs: false,
      roles: ["stateadmin"],
    },
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'ipviolation-report',
          title: 'IP Violation Report',
          type: 'item',
          url: '/reports/ipviolation-report',
          breadcrumbs: false,
          roles: ['superadmin'],
        },
        // {
